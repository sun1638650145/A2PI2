...
### 16.2.2.GradientBoostingClassifier()
...
## 16.5.model_selection

| 版本 | 描述                   | 注意 |
| ---- | ---------------------- | ---- |
| -    | sklearn的模型选择模块. | -    |

### 16.5.1.cross_val_predict()
